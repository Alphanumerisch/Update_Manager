...
export function logout() {
    ...
    .then(() => {
        ...
        localStorage.removeItem("access_token");  // Falls wir localStorage nutzen
        document.getElementById("navButtons").style.display = "none";  // 🔴 Navigation ausblenden!
        showLoginForm(); // ✅ Zeigt das Login-Formular an
    })
