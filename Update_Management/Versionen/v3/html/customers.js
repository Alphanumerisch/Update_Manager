...
export function loadCustomers() {
    ...
    data.forEach(customer => {
        ...
        // ✅ Löschen-Button mit CSS-Klasse "delete-button" erstellen
...
export function showCustomerForm() {
    ...
    cancelButton.classList.add("form-buttons");  // Falls du eine CSS-Klasse hast
    cancelButton.addEventListener("click", closeCustomerForm);

    // Den Button in die `.form-buttons`-Div einfügen
    form.querySelector(".form-buttons").appendChild(cancelButton);
