...
class RequestModel(BaseModel):
    ...
    role: Optional[constr(max_length=255)] = None
    add_customer_id: Optional[Union[int, List[conint(ge=1, le=1000000)]]] = None
    del_customer_id: Optional[Union[int, List[conint(ge=1, le=1000000)]]] = None
...
class BusinessTimeRequest(BaseModel):
    date: str
    start_time: str
